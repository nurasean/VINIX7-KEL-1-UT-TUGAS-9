      ...
      <section className="mx-auto flex h-[810px] w-[1440px] bg-[#001529]">
        ...
        <section className="flex h-[810px] w-[720px] flex-col items-center bg-[#002643] px-[24px] py-[80px]">
          ...
          >
            ...
            {/* USERNAME */}
            <div className="relative mb-[12px] w-[434px]">
              <label
                htmlFor="email"
              ...
              {state.errors?.email?.[0] && (
                <p
                  ...
                  className="mt-[4px] mb-0 text-[12px] leading-[18px] text-[#DB0606]"
                >
                  {state.errors.email[0]}
                </p>
              )}
            ...
            <div className="relative mb-[12px] w-[434px]">
              ...
              <div className="flex h-[53px] w-[434px] items-center justify-between rounded-[10px] border border-[#2176B5] bg-[#F0F2F8] px-[16px]">
                ...
                <button
                  ...
                  className="ml-[10px] flex h-[24px] w-[24px] shrink-0 cursor-pointer items-center justify-center border-0 bg-transparent p-0"
                >
                  {showPassword ? (
                    <svg
                      width="20"
                    ...
                    >
                      ...
                      />
                      <path
                        d="M10 12.5A2.5 2.5 0 1 0 10 7.5A2.5 2.5 0 0 0 10 12.5Z"
                        stroke="#546779"
                        strokeWidth="1.5"
                      />
                    </svg>
            ...
            {state.message && (
              <p
                aria-live="polite"
                className="mb-[8px] mt-0 w-[434px] text-center text-[13px] leading-[20px] text-[#DB0606]"
              >
                {state.message}
              </p>
            )}
            ...
            <p className="m-0 h-[24px] shrink-0 text-center text-[16px] font-normal leading-[24px] text-black">
              No Account?{" "}
              <Link href="/signup" className="text-[#2176B5] no-underline">
                Sign Up
              </Link>
            </p>
          </form>
